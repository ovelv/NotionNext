const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: 'OnionAI Search', url: 'https://onionai.so' },
    { title: 'AI Prompt', url: 'https://prompt.onionai.so' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'OnionAI Prompt',
  HEO_HERO_TITLE_2: 'Curated Prompts to Boost Your AI Creativity',
  HEO_HERO_TITLE_3: 'onionai.so',
  HEO_HERO_TITLE_4: 'OnionAI Search',
  HEO_HERO_TITLE_5: 'Efficiently Access Multiple AI Tools',
  ...
  HEO_INFO_CARD_URL: 'https://onionai.so', // 个人资料底部按钮链接
